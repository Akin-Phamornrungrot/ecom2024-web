...
const CartCard = () => {
  ...
  const actionRomoveProduct = useEcomStore(
    (state) => state.actionRomoveProduct
  );
        ...
        {carts.map((item, index) => (
          <div key={index} className="bg-white p-2 rounded-md shadow-md mb-2">
            ...
            <div className="flex justify-between mb-2">
              ...
              {/* right */}
              <div
                onClick={() => actionRomoveProduct(item.id)}
            ...
            <div className="flex justify-between">
              ...
              <div className="border rounded-sm px-2 py-1 flex items-center">
                <button
                  ...
                  className="px-2 py-1 bg-gray-200 ruonded-sm hover:bg-gray-500"
                >
                  <Minus size={16} />
                </button>
